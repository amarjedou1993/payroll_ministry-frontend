...
const Auth = () => {
  ...
  return (
    ...
    >
      ...
      {/* Left Column - Form */}
      <div className="px-4 sm:px-6 lg:px-8 grid items-center w-full max-w-full sm:max-w-md lg:max-w-xl mx-auto relative z-10">
        <div className="space-y-4 py-6 sm:py-8 lg:py-12">
          ...
          <div className="flex justify-end">
            <Select
              ...
              placeholder={t("selectLanguage")}
              className={`w-32 sm:w-40 rounded-lg border-gray-200 text-sm sm:text-base ${
                isRtl ? "font-arabic text-right" : "font-french text-left"
              }`}
            />
          </div>
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="bg-white rounded-2xl shadow-custom-soft p-6 sm:p-8"
          >
            ...
            >
              ...
              <FormField label={t("username")} htmlFor="username">
                <Input
                  ...
                  type="text"
                  placeholder={t("usernamePlaceholder")}
                  className="rounded-lg py-2.5 sm:py-3 px-3 sm:px-4 border-gray-200 focus:ring-2 focus:ring-emerald-500 text-sm sm:text-base"
                  aria-invalid={!!errors.username}
                />
                {errors.username && (
                  <div className="flex items-center mt-1.5 sm:mt-2 text-red-600 text-xs sm:text-sm">
                    <AlertCircleIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1" />
                    {errors.username.message}
                  </div>
                )}
              </FormField>
              ...
              {errorMessage && (
                <motion.div
                  initial={{ opacity: 0, scale: 0.95 }}
                  animate={{ opacity: 1, scale: 1 }}
                  className="p-2 sm:p-3 bg-red-50 border border-red-100 rounded-lg flex items-center gap-2 sm:gap-3"
                >
                  <AlertCircleIcon className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 flex-shrink-0" />
              ...
              <Button
                type="submit"
                loading={isPending}
                className="flex items-center gap-1 justify-center w-full py-2.5 sm:py-3.5 text-sm sm:text-base font-medium rounded-lg bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white shadow-md transition-all"
              >
                {t("login")}
                <LogInIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 ml-1 sm:ml-2" />
              </Button>
            </Form>
          </motion.div>
        </div>
        ...
        {/* Footer */}
        <Footer className="mt-6 sm:mt-8 lg:mt-12 text-center pb-4 sm:pb-6 xs:pb-8 lg:pb-10 text-xs sm:text-sm text-gray-400">
          <p
            dangerouslySetInnerHTML={{
              __html: t("footer", { year: new Date().getFullYear() }),
            }}
      ...
      >
        ...
        <div className="relative h-full flex flex-col justify-center px-8 lg:px-12">
          ...
          >
            <div className="mb-6 lg:mb-8 animate-float">
              <img
                src={isRtl ? sloganAR : slogan}
                alt={t("heroTitle")}
                className="w-full mx-auto filter drop-shadow-lg"
            ...
            <div className="space-y-4 lg:space-y-6 text-center">
              ...
              <p className="text-base lg:text-lg text-emerald-100 font-light leading-relaxed">
                {t("heroDescription")}
              </p>
            </div>
          </motion.div>
